...
import (
	...
	"flag"
	"fmt"
	"github.com/trongtb88/secure-grpc-in-go/client"
	"github.com/trongtb88/secure-grpc-in-go/pb"
	"github.com/trongtb88/secure-grpc-in-go/stores/sample"
...
/*
**
grpc client will dial to the server with the given address.
And authentication via tls file
*/
func main() {
	...
	log.Println("connected grpc server successfully")

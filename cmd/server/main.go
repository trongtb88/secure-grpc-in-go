...
import (
	...
	"github.com/trongtb88/secure-grpc-in-go/server"
	"github.com/trongtb88/secure-grpc-in-go/stores"
...
func seedUsers(userStore stores.UserStore) error {
...
func createUser(userStore stores.UserStore, username, password, role string) error {
...
func main() {
	...
	imageStore := stores.NewDiskImageStore("img")
	ratingStore := stores.NewInMemoryRatingStore()
	laptopServer := server.NewLaptopServer(laptopStore, imageStore, ratingStore)
